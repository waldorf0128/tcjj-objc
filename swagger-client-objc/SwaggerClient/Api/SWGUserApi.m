...
-(NSURLSessionTask*) callRegisterWithRegister: (SWGRegisterRequest*) _register
    ...
    // verify the required parameter '_register' is set
    if (_register == nil) {
        NSParameterAssert(_register);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"_register"] };
...
-(NSURLSessionTask*) changePasswordWithChangePassword: (SWGChangePasswordRequest*) changePassword
    ...
    if (changePassword == nil) {
        NSParameterAssert(changePassword);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"changePassword"] };
            NSError* error = [NSError errorWithDomain:kSWGUserApiErrorDomain code:kSWGUserApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/changePassword"];
...
-(NSURLSessionTask*) checkVarcodeWithCheckVarcode: (SWGCheckVarcodeRequest*) checkVarcode
    ...
    if (checkVarcode == nil) {
        NSParameterAssert(checkVarcode);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"checkVarcode"] };
            NSError* error = [NSError errorWithDomain:kSWGUserApiErrorDomain code:kSWGUserApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/checkVarcode"];
...
-(NSURLSessionTask*) getPhoneVarcodeWithGetPhoneVarcode: (SWGGetPhoneVarcodeRequest*) getPhoneVarcode
    ...
    if (getPhoneVarcode == nil) {
        NSParameterAssert(getPhoneVarcode);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"getPhoneVarcode"] };
            NSError* error = [NSError errorWithDomain:kSWGUserApiErrorDomain code:kSWGUserApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/getPhoneVarcode"];
...
-(NSURLSessionTask*) retrievePasswordWithRetrievePassword: (SWGRetrievePasswordRequest*) retrievePassword
    ...
    if (retrievePassword == nil) {
        NSParameterAssert(retrievePassword);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"retrievePassword"] };
            NSError* error = [NSError errorWithDomain:kSWGUserApiErrorDomain code:kSWGUserApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/retrievePassword"];
